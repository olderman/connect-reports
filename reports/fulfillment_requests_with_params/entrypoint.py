...
HEADERS = (
    ...
    'Parameter ID', 'Parameter Name', 'Parameter Title', 'Parameter Value', 'Parameter Description', 'Parameter Type',
    'Parameter Phase', 'Customer ID', 'Customer Name', 'Customer External ID',
